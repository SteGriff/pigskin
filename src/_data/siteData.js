const teamProfiles = [
  {
    ...
    Seasons: [2022, 2023],
    Rank: 5,
    Former: { Code: "SKY", Name: "Southport Skylarks" },
  },
  {
    ...
    Seasons: [2022],
    Rank: 7,
    Former: { Code: "ESQ", Name: "Esquel Collies " },
  },
  {
    TeamName: "On it like a Charbonnet",
    ...
    Seasons: [2022, 2023],
    Rank: 13,
    Former: { Code: "BRR", Name: "Burrow row row your boat" },
  },
  {
    TeamName: "Packers FC",
    ...
    Seasons: [2022],
    Rank: 14,
    Former: { Code: "PFC", Name: "Packers FC" },
  },
  {
    ...
    Seasons: [2022, 2023],
    Rank: 9,
    Former: { Code: "TBB", Name: "The Brady Bunch" },
  },
  {
    ...
    Seasons: [2022, 2023],
    Rank: 12,
    Former: { Code: "NAP", Name: "Naperville Bearcats" },
  },
  {
    TeamName: "Bijan for men",
    ...
    Seasons: [2022, 2023],
    Rank: 11,
    Former: { Code: "MFB", Name: "Mayfield Bakery" },
  },
  {
    TeamName: "TBC",
  ...
  },
  {
    ...
    Seasons: [2022, 2023],
    Rank: 10,
    Former: { Code: "CCL", Name: "The category is ‘country love’" },
  },
  {
    ...
    Seasons: [2022, 2023],
    Rank: 1,
    Former: { Code: "LCD", Name: "Lockett Down" },
  },
  {
    TeamName: "Beginners Luck",
    RealName: "Joel Naisbitt",
    Connection: "Mr Andrew Trebble",
    Supports: "Minnesota Vikings",
    NflYear1: "2020",
    FanYear1: "2020",
    Fact: "The BL mascot is a Emperor Penguin, which while unusual by itself, is even more odd due to the fact Beginners Luck are located in perpetually sunny South Florida.",
    Other:
      "As a now second year franchise, there was consideration taken change the name. However, market research showed that there is now strong recognition with the now iconic ‘Beginners Luck’ logo so the name stays. ",
    Code: "BGL",
    Seasons: [2022, 2023],
    Rank: 2,
    Former: { Code: "BGL", Name: "Beginners Luck" },
  },
  {
    ...
    Seasons: [2022, 2023],
    Rank: 3,
    Former: { Code: "RED", Name: "The Red Rifles" },
  },
  {
    TeamName: "Cannot touch my Williams",
    RealName: "Tom Langlois",
    Connection:
      "Brother of Josh. Brother in law of Tom B. Friend of Andy from Soul Survivor!",
    ...
    Seasons: [2023],
    Rank: 99,
    Former: { Code: "CTW", Name: "Cannot touch my Williams" },
  },
  {
    TeamName: "Resident American",
    RealName: "Ethan Langston",
    Connection:
      "Became friends with Trebz when I spent a semester at university of Liverpool in 2016 and have stayed in touch with some of the frontline crew ever since I went there. Still in an FPL league with many of them! ",
    Supports:
      "I guess the falcons because I live in atlanta but I cheer for my fantasy players over them, much bigger college football fan than nfl",
    NflYear1: "2000",
    FanYear1: "2007",
    ...
    Seasons: [2023],
    Rank: 100,
    Former: { Code: "USA", Name: "Resident American" },
  }
];
...
teamProfiles.forEach(
  (p) => (p.FanSeason = `${ordinate(season - p.FanYear1)} season`)
);
...
const alumniProfiles = teamProfiles.filter((x) =>
  x.Seasons.every((s) => s !== season)
);
